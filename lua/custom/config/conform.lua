require('conform').setup {
  ...
  formatters_by_ft = {
    ...
    json = { 'prettierd' },
    vue = { 'prettierd' },
    javascript = { 'prettierd', 'oxlint', 'eslint_d' },
    typescript = { 'prettierd', 'oxlint', 'eslint_d' },
    javascriptreact = { 'prettierd', 'oxlint', 'eslint_d' },
    typescriptreact = { 'prettierd', 'oxlint', 'eslint_d' },
  },
  formatters = {
